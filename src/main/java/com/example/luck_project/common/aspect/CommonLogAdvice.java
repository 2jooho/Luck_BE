...
//            RLOGGER.info("[" + this.strCRLF(servletPath) + "] UnsupportedEncodingException -> " + this.strCRLF(uee.getMessage()));
//        } catch(JsonProcessingException jpe) {
//            RLOGGER.info("[" + this.strCRLF(servletPath) + "] JsonProcessingException -> " + this.strCRLF(jpe.getMessage()));
//        } finally {
//            RLOGGER.info(this.strCRLF(log.toString()));
//        }
//    }
//
//    /**
